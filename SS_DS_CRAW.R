...
# max page check
tar<-"https://finance.naver.com/news/news_search.nhn?rcdate=&q=%C6%C4%BF%EE%B5%E5%B8%AE&x=19&y=13&sm=all.basic&pd=4&stDateStart=2020-01-01&stDateEnd=2020-01-20&page=1"
...
for(i in 1:max) {
  tar_url<-paste0("https://finance.naver.com/news/news_search.nhn?rcdate=&q=%C6%C4%BF%EE%B5%E5%B8%AE&x=19&y=13&sm=all.basic&pd=4&stDateStart=2020-01-01&stDateEnd=2020-01-20&page=",i)
  print(tar_url)
  read_html(tar_url,encoding="CP949") %>%
...
readr::write_excel_csv(aticles_dd,"SS_200101_200120")
...
readr::write_excel_csv(aticles_dt,"SS_200101_200120_2")
